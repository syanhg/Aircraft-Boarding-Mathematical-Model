...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title={\Large Hybrid Strategy - Step 6: Front Middle Seats (Rows 1-6, Seats B \& E)},
            xlabel={Seat Column},
            ylabel={Row Number},
        ...
        % Time indicator
        \node[font=\Large] at (axis cs:2.5,20.5) {t = 13 minutes};
        ...
        \node[draw, align=left, anchor=south west] at (axis cs:-0.5,-2) {
            ...
            \textcolor{purple}{Step 6: Front Middle Seats (Rows 1-6, Seats B \& E) - CURRENT}\\
