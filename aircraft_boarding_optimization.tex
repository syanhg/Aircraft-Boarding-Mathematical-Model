...
\end{axis}
\end{tikzpicture}
\caption{Simulation of proposed hybrid boarding strategy for Boeing 737-800 (114 passengers)}
\end{figure}

\section{Comparative Analysis of Boarding Strategies}

To evaluate the efficiency of different boarding strategies, we conducted simulation studies using the mathematical models developed in previous sections. The simulations were performed for a Boeing 737-800 aircraft with 114 passengers. Three main strategies were compared: back-to-front, outside-in, and our proposed hybrid strategy. Figure \ref{fig:strategy-comparison} shows the comparison of total boarding times for these strategies.
...
\addlegendentry{Outside-In (10 min)}
...
\end{axis}
\end{tikzpicture}
\caption{Comparison of boarding strategies for Boeing 737-800 (114 passengers)}
...
Comparing to real-world observed data, we see that all strategies take longer in practice than in our idealized model. However, the relative improvements are consistent with our model predictions. The hybrid strategy shows a 25.0% improvement over random boarding in real-world conditions.
